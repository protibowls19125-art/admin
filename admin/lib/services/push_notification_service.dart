...
/// Registers this browser for FCM push (fires the "New order received"
/// notification from send-order-push-notification even when this tab is
/// closed) and re-shows it manually while the tab IS open, since FCM's
/// foreground messages don't auto-popup like background ones do.
///
